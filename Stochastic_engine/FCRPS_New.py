...
#        VAQRnew_HHO = np.zeros((sim_days,1))
    ...
    generation[i,5] = ((1000*HHO_head[i]* powerflow[i,5] *14.27641*9.81*.84)/1000000)*24 
...
#    ALB_sfore = np.zeros((sim_days,1))
    ...
    generation[i,7] = ((1000*ALB_head*powerflow[i,7]*14.27641*9.81*.71)/1000000)*24 
...
#    Spillheads = np.zeros((sim_days,11))
    ...
    generation[i,28] = ((1000*CHJ_head[i]*powerflow[i,28]*14.27641*9.81*.84)/1000000)*24 
    ...
    generation[i,40] = ((1000*JDA_head[i]*powerflow[i,40]*14.27641*9.81*.87)/1000000)*24 
    ...
    generation[i,41] = ((1000*TDA_head*powerflow[i,41]*14.27641*9.81*.86)/1000000)*24 
    heads[i,8]=TDA_head 
    ...
    generation[i,42] = ((1000*BNN_head*powerflow[i,42]*14.27641*9.81*.92)/1000000)*24 
    heads[i,9]=BNN_head 
