...
def sim(days):
    ...
    instance = model.create_instance('../Model_setup/WC_data_file/data.dat')
    ...
    #            
        WC_result = opt.solve(instance)
        instance.solutions.load_from(WC_result)   
            ...
            if a=='mwh_1':
             ...
             for index in varobject:
               ...
               if int(index[1]>0 and index[1]<25):
                ...
                elif index[0] in instance.WECCImportsPNW:
                    
                    marginal_cost = 5 #come back to this
                    mwh_1.append((index[0],index[1]+((day-1)*24),varobject[index].value,'PNW','imports',marginal_cost))     
             ...
             for index in varobject:
               ...
               if int(index[1]>0 and index[1]<25):
                if index[0] in instance.Zone1Generators:
                    ...
                    marginal_cost = 5
                    mwh_2.append((index[0],index[1]+((day-1)*24),varobject[index].value,'PNW','imports',marginal_cost))  
             ...
             for index in varobject:
               ...
               if int(index[1]>0 and index[1]<25):
                if index[0] in instance.Zone1Generators:
                    ...
                    marginal_cost = 5
                    mwh_3.append((index[0],index[1]+((day-1)*24),varobject[index].value,'PNW','imports',marginal_cost))    
    ...
    flow_pd.to_csv('WC/flow.csv')
    mwh_1_pd.to_csv('WC/mwh_1.csv')
    mwh_2_pd.to_csv('WC/mwh_2.csv')
    mwh_3_pd.to_csv('WC/mwh_3.csv')
    on_pd.to_csv('WC/on.csv')
    switch_pd.to_csv('WC/switch.csv')
    srsv_pd.to_csv('WC/srsv.csv')
    nrsv_pd.to_csv('WC/nrsv.csv')
    solar_pd.to_csv('WC/solar_out.csv')
    wind_pd.to_csv('WC/wind_out.csv')
